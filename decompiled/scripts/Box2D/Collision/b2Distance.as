   ...
   public class b2Distance
   {
      ...
      public static function InPoints(param1:b2Vec2, param2:Array, param3:int) : Boolean
      {
         ...
         while(_loc5_ < param3)
         {
            ...
            _loc7_ = param1.x - _loc6_.x < 0 ? -(param1.x - _loc6_.x) : param1.x - _loc6_.x;
            _loc8_ = param1.y - _loc6_.y < 0 ? -(param1.y - _loc6_.y) : param1.y - _loc6_.y;
            _loc9_ = param1.x < 0 ? -param1.x : (param1.x > _loc6_.x < 0 ? -_loc6_.x : (_loc6_.x ? (param1.x < 0 ? -param1.x : param1.x) : (_loc6_.x < 0 ? -_loc6_.x : _loc6_.x)));
            _loc10_ = param1.x < 0 ? -param1.y : (param1.y > _loc6_.y < 0 ? -_loc6_.y : (_loc6_.y ? (param1.y < 0 ? -param1.y : param1.y) : (_loc6_.y < 0 ? -_loc6_.y : _loc6_.y)));
      ...
      public static function DistanceGeneric(param1:b2Vec2, param2:b2Vec2, param3:*, param4:b2XForm, param5:*, param6:b2XForm) : Number
      {
         ...
         while(_loc14_ < _loc13_)
         {
            ...
            if(_loc12_ <= 100 * Number.MIN_VALUE * _loc22_)
            {
               g_GJK_Iterations = _loc14_;
               _loc15_ = param2.x - param1.x;
               _loc16_ = param2.y - param1.y;
      ...
      public static function DistanceEdgeCircle(param1:b2Vec2, param2:b2Vec2, param3:b2EdgeShape, param4:b2XForm, param5:b2CircleShape, param6:b2XForm) : Number
      {
         var _loc7_:b2Vec2 = null;
         var _loc9_:b2Mat22 = null;
         var _loc10_:b2Vec2 = null;
         var _loc8_:Number = param5.m_radius - b2Settings.b2_toiSlop;
         _loc9_ = param6.R;
         _loc10_ = param5.m_localPosition;
         var _loc11_:Number = param6.position.x + (_loc9_.col1.x * _loc10_.x + _loc9_.col2.x * _loc10_.y);
         var _loc12_:Number = param6.position.y + (_loc9_.col1.y * _loc10_.x + _loc9_.col2.y * _loc10_.y);
         _loc9_ = param4.R;
         var _loc13_:Number = _loc11_ - param4.position.x;
         var _loc14_:Number = _loc12_ - param4.position.y;
         var _loc15_:Number = _loc13_ * _loc9_.col1.x + _loc14_ * _loc9_.col1.y;
         var _loc16_:Number = _loc13_ * _loc9_.col2.x + _loc14_ * _loc9_.col2.y;
         var _loc17_:Number = (_loc15_ - param3.m_coreV1.x) * param3.m_direction.x + (_loc16_ - param3.m_coreV1.y) * param3.m_direction.y;
         if(_loc17_ <= 0)
         {
            _loc9_ = param4.R;
            _loc10_ = param3.m_coreV1;
            param1.x = param4.position.x + (_loc9_.col1.x * _loc10_.x + _loc9_.col2.x * _loc10_.y);
            param1.y = param4.position.y + (_loc9_.col1.y * _loc10_.x + _loc9_.col2.y * _loc10_.y);
         }
         else
         {
            if(_loc17_ < param3.m_length)
            {
               _loc9_ = param4.R;
               _loc13_ = param3.m_coreV1.x + _loc17_ * param3.m_direction.x;
               _loc14_ = param3.m_coreV1.y + _loc17_ * param3.m_direction.y;
               param1.x = param4.position.x + (_loc9_.col1.x * _loc13_ + _loc9_.col2.x * _loc14_);
               param1.y = param4.position.y + (_loc9_.col1.y * _loc13_ + _loc9_.col2.y * _loc14_);
               _loc17_ = (_loc15_ - param3.m_coreV1.x) * param3.m_normal.x + (_loc16_ - param3.m_coreV1.y) * param3.m_normal.y;
               if(_loc17_ < 0)
               {
                  if(_loc17_ < -_loc8_)
                  {
                     _loc9_ = param4.R;
                     _loc13_ = _loc15_ + _loc8_ * param3.m_normal.x;
                     _loc14_ = _loc16_ + _loc8_ * param3.m_normal.y;
                     param2.x = param4.position.x + (_loc9_.col1.x * _loc13_ + _loc9_.col2.x * _loc14_);
                     param2.y = param4.position.y + (_loc9_.col1.y * _loc13_ + _loc9_.col2.y * _loc14_);
                     return -_loc17_ - _loc8_;
                  }
                  param2.x = param1.x;
                  param2.y = param1.y;
                  return 0;
            ...
            _loc9_ = param4.R;
            _loc10_ = param3.m_coreV2;
            param1.x = param4.position.x + (_loc9_.col1.x * _loc10_.x + _loc9_.col2.x * _loc10_.y);
            param1.y = param4.position.y + (_loc9_.col1.y * _loc10_.x + _loc9_.col2.y * _loc10_.y);
         }
         _loc13_ = _loc11_ - param1.x;
         _loc14_ = _loc12_ - param1.y;
         _loc17_ = _loc13_ * _loc13_ + _loc14_ * _loc14_;
         if(_loc17_ > _loc8_ * _loc8_)
         {
            _loc17_ = Math.sqrt(_loc17_);
            param2.x = _loc11_ - _loc8_ * _loc13_ / _loc17_;
            param2.y = _loc12_ - _loc8_ * _loc14_ / _loc17_;
            return _loc17_ - _loc8_;
         }
         param2.x = param1.x;
         param2.y = param1.y;
      ...
      public static function Distance(param1:b2Vec2, param2:b2Vec2, param3:b2Shape, param4:b2XForm, param5:b2Shape, param6:b2XForm) : Number
      {
         ...
         {
            return DistanceGeneric(param1,param2,param3,param4,param5,param6);
         }
         if(_loc7_ == b2Shape.e_edgeShape && _loc8_ == b2Shape.e_circleShape)
         {
            return DistanceEdgeCircle(param1,param2,param3 as b2EdgeShape,param4,param5 as b2CircleShape,param6);
         }
         if(_loc7_ == b2Shape.e_circleShape && _loc8_ == b2Shape.e_edgeShape)
         {
            return DistanceEdgeCircle(param2,param1,param5 as b2EdgeShape,param6,param3 as b2CircleShape,param4);
         }
         if(_loc7_ == b2Shape.e_polygonShape && _loc8_ == b2Shape.e_edgeShape)
         {
            return DistanceGeneric(param2,param1,param5,param6,param3,param4);
         }
         if(_loc7_ == b2Shape.e_edgeShape && _loc8_ == b2Shape.e_polygonShape)
         {
            return DistanceGeneric(param1,param2,param3,param4,param5,param6);
         }
         return 0;
